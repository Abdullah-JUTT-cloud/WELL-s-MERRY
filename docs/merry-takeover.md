...
`/outlets`, `/product/:slug`). The legacy gold/ivory experience remains
intact for the remaining utility pages (cart, checkout, auth, blog,
about, contact, shipping, orders) and will be migrated (or retired)
separately.
...
src/
  ...
  components/merry/           ← design system (Layout, Navbar, Footer,
